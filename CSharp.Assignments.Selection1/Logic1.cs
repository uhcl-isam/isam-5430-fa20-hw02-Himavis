...
namespace CSharp.Assignments.Loop1
{
    public class Logic1
    {
        ...
        /// in which the alarm will then ring at "10:00" on the weekdays but "off"
        /// during the weekend.
        /// </summary>
        ...
        public static string AlarmClock(DayOfWeek dayOfWeek, bool vacation)
        {
            if (!vacation)
            {
                if (Convert.ToInt32(dayOfWeek) >= 1 && Convert.ToInt32(dayOfWeek) <= 5)
                {
                    return "7:00";
                }
                return "10:00";
        ...
        /// <summary>
        /// A hilly number is defined to be a number
        /// with all the left digits in an ascending order, 
        ...
        public static bool CloseFar(int a, int b, int c)
        {
            ...
            else if (Math.Abs(a - b) >= 2 && Math.Abs(b - c) <= 1 && Math.Abs(a - c) >= 2)

            {
                return true;
            }

            else if (Math.Abs(a - b) >= 2 && Math.Abs(b - c) >= 2 && Math.Abs(a - c) <= 1)
